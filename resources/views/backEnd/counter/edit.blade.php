    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <a href="{{ route('counter.index') }}" class="btn btn-primary rounded-pill">Manage</a>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('counter.update') }}" method="POST" class="row" data-parsley-validate=""
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('counter') is-invalid @enderror"
                                        name="counter" value="{{ $edit_data->counter }}" id="counter" required="">
                                    @error('counter')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
