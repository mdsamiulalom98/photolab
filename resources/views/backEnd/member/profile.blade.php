        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <a href="{{route('admin.members.index', ['member'=>$profile->type])}}" class="btn btn-primary rounded-pill">Customer List</a>
                    <form method="post" action="{{route('admin.members.adminlog')}}" class="d-inline" target="_blank">
                        @csrf
