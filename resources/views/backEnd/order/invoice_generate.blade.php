                        ...
                        <form action="" class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control flatpickr" placeholder="Start Date"  id="start_date" name="start_date" required>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="mb-3">
                                    <label for="end_date" class="form-label">End Date:</label>
                                    <input type="date" class="form-control flatpickr" placeholder="End Date"  id="end_date" name="end_date" required>
                                </div>
                            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <button  class="no-print btn  btn-success waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#seller_payment"><i class="fa-solid fa-paper-plane"></i> Send To Buyer</button>
                    ...
                    <table class="table" style="margin-top: 30px; margin-bottom: 0;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="border-color:#ddd">{{$details->order?->order_name}}</td>
                                <td style="border-color:#ddd">{{$details->qty}}</td>
                                <td style="border-color:#ddd">{{$details->order?->currency == 'usd' ? '$' : '৳'}} {{$details->sale_price}}</td>
                                <td style="border-color:#ddd">{{$details->order?->currency == 'usd' ? '$' : '৳'}} {{$details->sale_price*$details->qty}}</td>
                            </tr>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="account_number" class="form-control" value="" required>
                </div>
                <div class="form-group mb-3">
