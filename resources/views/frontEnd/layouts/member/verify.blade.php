            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-sm-12">
                    <div class="alert alert-danger alert-dismissible">
                        ...
                        <p>Your Verify OTP Is : {{App\Models\Member::where('phone',Session::get('verify_phone'))->first()->verify}}</p>
                        @endif
                    </div>
                    <div class="auth-inner">
                        <h5 class="title">Account Verify</h5>

                        <form action="{{ route('member.account.verify') }}" method="POST" data-parsley-validate="">
                            @csrf
